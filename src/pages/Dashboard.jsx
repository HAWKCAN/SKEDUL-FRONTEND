          ...
          <div className="bg-[#ffffff] border-solid rounded-md border-1 mr-5 pl-2">
            ...
            <table className="w-[100%] text-center mt-2 mb-2">
              ...
              <tr>
                ...
                <td>
                  <button className="bg-[#ABC4FF] rounded-md hover:bg-[#5e74f6] w-15 h-7 mr-1 cursor-pointer">Terima</button>
                  <button className="bg-[#ABC4FF] rounded-md hover:bg-[#5e74f6] w-15 h-7 ml-1 cursor-pointer">Tolak</button></td>
              </tr>
            </table>
          </div>

          <h1 className="text-[20px] font-bold mt-3">Histori Peminjaman</h1>
          <div className="bg-[#ffffff] border-solid border-1 rounded-md mr-5 pl-2">
            <table className="w-[100%] text-center mt-2 mb-2">
              <tr>
                <th>No</th>
                <th>Tanggal</th>
